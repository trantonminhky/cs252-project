...
The platform is designed to address the specific pain points of two primary user groups who currently face significant friction in discovering cultural experiences:
...
The search pipeline is built upon a hybrid architecture that combines semantic search and lexical search techniques to optimize both relevance and precision in results. The system supports \textbf{multimodal input}, allowing users to query the database using natural language prompts, image inputs for visual search, specific categorical filters, or direct entity name lookups. The key components of this pipeline are as follows:
