...
\begin{figure}[!h]
  \centering
  \includegraphics[width=\linewidth]{externals/uml/class-diagram.png}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=\linewidth]{externals/uml/class-diagram-frontend.png}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=\linewidth]{externals/uml/class-diagram-ai-backend.png}
  \caption{AI backend architecture.}
\end{figure}

\quad The AI backend is a FastAPI app that exposes a recommendation endpoint. The entrypoint (Main) creates the FastAPI app, adds CORS middleware, and includes the RecommendationRouter. The router defines the recommend(...) endpoint, which accepts a RecommendationRequest (user\_id, query, top\_k, filters) and returns a RecommendationResponse containing a list of ItemScore (place\_id, score, explanation).

\newpage

\begin{figure}[!h]
  \centering
  \includegraphics[width=\linewidth]{externals/uml/class-diagram-backend.png}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=\linewidth]{externals/uml/class-diagram-db.png}
